...
import { getFollowersByUserId, getFollowingByUserId, getMyFollowing } from "../controllers/follow.controller";
...
userRouter.get("/following", authenticate, getMyFollowing);
